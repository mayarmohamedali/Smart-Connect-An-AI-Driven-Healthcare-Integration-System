 ...
 * ✅ Full Data Visibility for Patient — All new schema fields included
 */
...
function delta_class($val): string {
  if ($val === null || $val === "") return "text-secondary";
  return ((float)$val >= 0) ? "text-success" : "text-danger";
}

function delta_icon($val): string {
...
function yn($val): string {
  return $val ? '<span class="badge badge-warning">Yes</span>'
...
$monthName = $monthNames[(int)$rec["month"]] ?? e($rec["month"]);

// disease category badge color map
$catColors = [
...
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
    <a href="PatientDashboard.php#medical" class="btn btn-outline-secondary shadow-sm">
