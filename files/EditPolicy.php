<?php
/**
 * EditPolicy.php - OOP Version
 * Create or edit a specific policy configuration
 */
...
// Get category and customer type names
$category_name = ($category_id == 1) ? 'Normal' : 'VIP';
$customer_type_name = ($customer_type_id == 1) ? 'Individual' : 'Company';

// Check if policy already exists
$existing_plan = $insurancePlan->getPlanByType($insurance_id, $category_id, $customer_type_id);
$is_editing = !empty($existing_plan);

// If editing, get existing services
$existing_services = [];
if ($is_editing) {
    $existing_services = $insurancePlan->getServicesByPlanId($existing_plan['plan_id']);
}

// Convert to associative array for easier access
$service_data = [];
foreach ($existing_services as $service) {
    $service_data[$service['service_id']] = $service;
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success shadow sticky-top">
  <div class="container-fluid">
    ...
    <a href="Policy.php" class="btn btn-light btn-sm ml-auto">
...
<div class="container mt-4 mb-5">
  ...
  <!-- Policy Form -->
  <form method="POST" action="save_policy.php" id="policyForm">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <a href="Policy.php" class="btn btn-secondary">
