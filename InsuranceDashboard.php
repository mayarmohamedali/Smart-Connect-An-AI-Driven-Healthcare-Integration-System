 ...
 * Shows only the logged-in insurance company's prediction
 */
...
$insurance_name = trim($insurance->getName());
        ...
        <div class="insurance-alert-banner d-flex align-items-center justify-content-between flex-wrap">
            <div>
                <h5 class="insurance-alert-title mb-1">
                    <i class="fas fa-exclamation-triangle mr-2"></i> High Priority Insurance Alert
                </h5>
                <p class="insurance-alert-subtitle">AI-based pricing prediction for the upcoming period</p>
            </div>
            <span class="insurance-prediction-count">1 Prediction</span>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="prediction-meta">
                            ...
                            <p>
                                ...
                                <span class="confidence-badge"><?= number_format((float)$current_prediction["confidence"], 1) ?>%</span>
                            </p>
                            <p><strong>Predicted Increase:</strong> <?= (int)$current_prediction["predicted_increase"] ?>%</p>
                        </div>

                        <div class="prediction-action-box">
                            <i class="fas fa-lightbulb mr-2"></i>
                            <strong>Action:</strong> <?= Validator::sanitizeInput($current_prediction["action"]) ?>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="prediction-list">
                                <li>Monitor <?= Validator::sanitizeInput($insurance_name) ?> premium trend</li>
