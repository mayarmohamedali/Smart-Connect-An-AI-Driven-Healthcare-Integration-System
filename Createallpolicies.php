<?php
/**
 * CreateAllPolicies.php
 * Single form to configure ALL 4 policy types at once
 */
...
<div class="container-fluid mt-4 mb-5">
    ...
    <form method="POST" action="save_all_policies.php" id="allPoliciesForm">
        ...
        <div class="sticky-submit">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-right">
                    <a href="InsuranceDashboard.php" class="btn btn-secondary mr-2">
