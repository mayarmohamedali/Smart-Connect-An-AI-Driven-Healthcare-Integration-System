...
<div class="container-fluid py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <a href="HospitalDashboard.php#patients" class="btn btn-outline-secondary">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
      ...
      <a href="AddMedicalRecord.php?patient_id=<?= (int)$patient_id ?>" class="btn btn-sm btn-primary">
  ...
  <div id="details" class="card shadow mt-4">
    <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
      ...
      <div>
        <a href="EditMedicalRecord.php?patient_id=<?= (int)$patient_id ?>&record_id=<?= (int)$selected_record["record_id"] ?>"
           class="btn btn-sm btn-light mr-2">
          <i class="fas fa-edit mr-1"></i> Edit This Record
        </a>
        <a href="ViewMedicalRecords.php?patient_id=<?= (int)$patient_id ?>"
