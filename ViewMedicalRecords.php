...
// hospital_id from session (or default 1 for now)
$hospital_id = (int)($_SESSION["hospital_id"] ?? 1);

// patient_id must come from URL
...
========================= */
$stmt = $conn->prepare("
  SELECT patient_id, full_name, national_id, phone, gender, address
  FROM patients
  WHERE patient_id = ?
  LIMIT 1
");
...
<a class="btn btn-sm btn-outline-success"
  ...
  <!-- ✅ ONLY DETAILS BLOCK (what you want) -->
