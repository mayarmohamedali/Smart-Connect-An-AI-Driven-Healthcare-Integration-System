...
/* =========================
   ...
   - No search: only patients added by this hospital
   - With search: search across ALL patients (including insurance-added)
========================= */
$q = trim($_GET["q"] ?? "");
$patients = [];
...
<div class="container-fluid py-4">
  ...
  <!-- KEEP THE REST (claims, insights, staff) AS YOU HAD IT -->
  <!-- ... (unchanged) ... -->
    <!-- your existing claims UI here -->
       <!-- ================= CLAIMS SECTION ================= -->
    ...
    <div class="row">
      <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <canvas id="outbreakChart" height="120"></canvas>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <canvas id="claimStatusChart" height="180"></canvas>
          </div>
        </div>
      </div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // ---- Line Chart (beautiful colors) ----
  var outbreakCanvas = document.getElementById("outbreakChart");
  if (outbreakCanvas) {
    var ctx = outbreakCanvas.getContext("2d");
    new Chart(ctx, {
      type: "line",
      data: {
  ...
  // ---- Doughnut Chart (beautiful colors) ----
  var claimCanvas = document.getElementById("claimStatusChart");
  if (claimCanvas) {
    var ctx2 = claimCanvas.getContext("2d");
    new Chart(ctx2, {
      type: "doughnut",
      data: {
        ...
        datasets: [{
          ...
          hoverBackgroundColor: ["#2c9faf", "#dda20a", "#17a673", "#c0392b"],
          borderWidth: 1
        }]
      },
      options: {
