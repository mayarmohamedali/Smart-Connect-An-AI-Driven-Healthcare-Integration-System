...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="HospitalDashboard.html">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="HospitalDashboard.html">
            ...
            <li class="nav-item">
                <a class="nav-link" href="Lookup_patient.html">
                    <i class="fas fa-id-card"></i>
                    <span>Lookup Patient by National ID</span></a>
            </li>
           

            <hr class="sidebar-divider">
            <div class="sidebar-heading">Insurance Claims</div>

            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-file-invoice-dollar"></i>
                    <span>Submit Treatment Costs</span></a>
           
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#claimStatus"
                    aria-expanded="true" aria-controls="claimStatus">
                    <i class="fas fa-tasks"></i>
                    <span>Claim Status</span>
                </a>
                <div id="claimStatus" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Submitted</a>
                        <a class="collapse-item" href="#">Under Review</a>
            ...
            <hr class="sidebar-divider">
            <div class="sidebar-heading">Operational Insights</div>

            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-chart-line"></i>
                    <span>Disease Outbreak Patterns (AI Analytics)</span></a>
            </li>

            <hr class="sidebar-divider">
            <div class="sidebar-heading">Hospital Profile</div>

            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-hospital"></i>
                    <span>Hospital Info & Departments</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-handshake"></i>
                    <span>Insurance Partnerships</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-user-shield"></i>
                    <span>Staff Roles & Permissions</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h4 class="text-primary ml-3">Hospital Dashboard</h4>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Admitted Patients</div>
    ...
    <!-- Page Level Charts JS -->
    <script>
        // Example placeholder chart for outbreak
        ...
        // Example placeholder chart for claim status
