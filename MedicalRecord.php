...
class MedicalRecord {
    ...
    public function setRiskScores($stress_level = null, $family_history = null,
                                   $medications_count = null, $risk_score = null,
                                   $symptom_burden = null, $seasonal_weight = null) {
    ...
    public function setSymptoms($fever = null, $cough = null, $fatigue = null,
                                 $chest_pain = null, $shortness_of_breath = null,
                                 $headache = null) {
        $this->fever               = $fever;
        $this->cough               = $cough;
...
$stmt->bind_param($types, ...$params);
    ...
    public function getRecordsByPatient($patient_id, $limit = 20) {
        $stmt = $this->conn->prepare("
            SELECT record_id, created_at, checkin_date, checkout_date, diagnosis, disease_category,
                   has_diabetes, has_hypertension, has_kidney_disease, has_heart_disease
